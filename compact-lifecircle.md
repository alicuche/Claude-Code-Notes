...
│  │ "system": [...]                                     ~25K tokens   │  │
│  │                                                                    │  │
│  │  [0] { type: "text", text: "<billing header>" }          84 chars │  │
│  │  [1] { type: "text", text: "You are a Claude agent..." } 62 chars │  │
...
│  │                                                                    │  │
│  │              BEFORE                AFTER                           │  │
│  │  "system":   25K tokens    →    25K tokens   (unchanged)          │  │
│  │  "tools":    18K tokens    →    18K tokens   (unchanged)          │  │
│  │  "messages": 77K tokens    →     8K tokens   (reduced 90%)       │  │
│  │  ──────────────────────────────────────────────────                │  │
