...
│  │  ┌─ [2] { role: "assistant" } ────────────────────────────────┐  │  │
│  │  │  content: [                                                 │  │  │
│  │  │    { type: "text", text: "To create this feature..." },     │  │  │
...
│  │  ┌─ [4] { role: "assistant" } ────────────────────────────────┐  │  │
│  │  │  content: [                                                 │  │  │
│  │  │    { type: "text", text: "Got it. Checking routes..." },    │  │  │
│  │  │    { type: "tool_use", id: "toolu_def456", name: "Grep",    │  │  │
...
│  │  ┌─ [6] { role: "assistant" } ────────────────────────────────┐  │  │
│  │  │  content: [                                                 │  │  │
│  │  │    { type: "text", text: "Creating LoginPage..." },         │  │  │
│  │  │    { type: "tool_use", id: "toolu_ghi789", name: "Write",   │  │  │
│  │  │        input: { file_path: "src/Login.tsx", content: "..." }}│  │  │
│  │  │  ]                                                          │  │  │
│  │  └────────────────────────────────────────────────────────────┘  │  │
│  │  ┌─ [7] { role: "user" } ─────────────────────────────────────┐  │  │
│  │  │  content: [{ type: "tool_result",                           │  │  │
...
│  │  ┌─ [8] { role: "assistant" } ────────────────────────────────┐  │  │
│  │  │  content: [{ type: "text",                                  │  │  │
│  │  │    text: "LoginPage created. Need unit tests?" }]           │  │  │
│  │  └────────────────────────────────────────────────────────────┘  │  │
│  │  ┌─ [9] { role: "user" } ─────────────────────────────────────┐  │  │
│  │  │  content: [                                                 │  │  │
│  │  │    { type: "text", text: "<system-reminder>                 │  │  │
...
│  │  │     3. Files: src/app.ts, src/Login.tsx, src/routes.ts      │  │  │
│  │  │     4. Errors: none                                         │  │  │
│  │  │     5. Problem Solving: Read → Grep → Write                 │  │  │
